...
public class DList1 {
  ...
  public int width, height, starveTimer;
  ...
  public DList1(int w, int h, int s)
  {
      width = w;
      height = h;
      starveTimer = s;
   ...
   */
  public void insertFront(int obj, int length, int starveTimer) {
    // Your solution here.
      if(size == 0)
      {
          head = new DListNode1(obj, length, starveTimer);
          tail = head;
      }
      else{
        DListNode1 interm = new DListNode1(obj, length, starveTimer);
        interm.next = tail;
        tail.prev = interm;
        head = interm;
      }
  ...
  public void insertEND(int obj, int length, int starveTimer) {
    // Your solution here.
      if(size == 0)
      {
          head = new DListNode1(obj, length, starveTimer);
